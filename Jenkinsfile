        ...
        try {
            stage('Unit Test') {
                container("dotnet") {
                    ...
                    step ([$class: 'MSTestPublisher', testResultsFile:"/home/jenkins/agent/workspace/pipeline-devops/test/AspNetCoreInDocker.Web.Tests/test_results/result.xml", failOnError: true, keepLongStdio: true])
                }
            }
        } catch(e) {
